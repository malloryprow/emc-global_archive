...
for model in $model_list; do
    ...
    if [ $model = "graphcastgfs" ]; then cycles="00 06 12 18"; fhrmin=6; fhrmax=384; fhrinc=6;  fi
    if [ $model = "eagle_solo" ]; then cycles="00 06 12 18"; fhrmin=6; fhrmax=384; fhrinc=6;  fi
